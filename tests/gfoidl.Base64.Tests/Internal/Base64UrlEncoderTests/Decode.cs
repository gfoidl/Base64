...
namespace gfoidl.Base64.Tests.Internal.Base64UrlEncoderTests
{
    ...
    public class Decode<T> where T : unmanaged
    {
        ...
        public void Malformed_input_to_byte_array___status_InvalidData(string input)
        {
            var sut = new Base64UrlEncoder();
        ...
        {
            yield return new TestCaseData("1234a=");
            yield return new TestCaseData("1234abc?");
            yield return new TestCaseData("1234ab?c");
            yield return new TestCaseData("1234ab=c");
            yield return new TestCaseData("1234abc=");
            yield return new TestCaseData("1234abc+");      // char from base64
            yield return new TestCaseData("1234abc/");      // char from base64
        }
        //---------------------------------------------------------------------
        private static IEnumerable<TestCaseData> Malformed_input___status_InvalidData_TestCasesWithIsFinalBlock()
        {
            ...
            foreach (TestCaseData testCaseData in Malformed_input_to_byte_array___throws_FormatException_TestCases().Skip(1))
